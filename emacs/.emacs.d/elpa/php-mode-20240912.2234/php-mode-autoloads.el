...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "php-complete" '("php-complete--")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "php-defs" '("php-defs-functions-alist")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "php-face" '("php-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "php-flymake" '("php-flymake-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "php-format" '("php-format-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "php-ide" '("php-ide-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "php-ide-phpactor" '("php-ide-phpactor-")))
